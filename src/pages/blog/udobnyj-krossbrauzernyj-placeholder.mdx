...
date: "2011-05-15"
dateUX: "15 мая 2011"
description: 'Реализация подсказки в&nbsp;виде, спозиционированная над полем ввода, исчезающая при заполнении, плюс &laquo;умная очищалка&raquo; содержимого поля, появляющаяся/исчезающая при вводе/удалении содержимого поля, демо-страничка с&nbsp;тем, что должно в&nbsp;итоге получиться.'
